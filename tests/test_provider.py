...
async def test_spawn_agent_forwards_mcp_foreground(tmp_path):
    ...
    async def fake_runner(type, task, tool_call_id, mcp_names, max_output_chars=None, model=None):
...
async def test_spawn_agent_forwards_mcp_background(tmp_path):
    ...
    def fake_bg(type, task, mcp_names, max_output_chars=None, model=None):
