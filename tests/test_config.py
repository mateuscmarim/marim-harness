...
def test_native_codex_qualified_prefix_is_recognised():
    from marim_harness.config.context_limits import _bare_id

    assert _bare_id("openai-codex:gpt-5.6-sol") == "gpt-5.6-sol"
